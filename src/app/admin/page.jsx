...
import ArticlesListClient from './articles-list/ArticlesListClient'
...
export default async function AdminPage({ searchParams }) {
  ...
  // Serialize dates so they pass cleanly to the client component
  const serialized = guides.map(g => ({ ...g, updatedAt: g.updatedAt.toISOString(), createdAt: g.createdAt.toISOString() }))
  ...
  return (
    <div style={{ maxWidth: 960, margin: '40px auto', padding: '0 24px' }}>
      ...
      <ArticlesListClient guides={serialized} />
    </div>
  )
}
